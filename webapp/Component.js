	...
	_performInitialNavigation: function () {
		...
		if (this.oStartupParameters.isModeActive()) { // taskcenter
			...
			if (!taskcenterHash && sInstanceID && sSAP__Origin) { // deeplink scenario without hash
				...
				// eslint-disable-next-line camelcase
				oRouter.navTo("myTasksDetailDeep", {
					SAP__Origin: encodeURIComponent(sSAP__Origin),
					InstanceID: encodeURIComponent(sInstanceID), layout: "MidColumnFullScreen"
				}, null, bReplaceHistory);
			}
